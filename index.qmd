...
::: {layout="[[1,1,1], [1,1,1], [-0.5,1,1,-0.5]]" .center}
...
![**Leon van Paassen** <br/> Boskalis](./img/leon-official.png){.rounded-circle}

![**Jason DeJong** <br/> University of California, Davis](img/jason.svg){.rounded-circle}
:::
